    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://gitee.com/zhoushangshi8/blog-back-up/blob/master/min_photos/2.jpg' + data.link[i];
          var src = 'https://gitee.com/zhoushangshi8/blog-back-up/blob/master/photos/' + data.link[i];
